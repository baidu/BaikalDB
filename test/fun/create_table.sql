...
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50 COMMENT='{"resource_tag":"", "replica_num":3, "ttl_duration":86400, "region_split_lines":2097152, "namespace":"FENGCHAO"}';
...
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50000 COMMENT='{"resource_tag":"", "replica_num":3, "namespace":"FENGCHAO"}';
...
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50 COMMENT='{"resource_tag":"", "replica_num":3, "region_split_lines":100, "namespace":"FENGCHAO"}';
...
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50 COMMENT='{"resource_tag":"", "replica_num":3, "region_split_lines":10, "namespace":"FENGCHAO"}';
...
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50 COMMENT='{"resource_tag":"", "replica_num":3, "region_split_lines":200, "namespace":"FENGCHAO"}';
...
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50 COMMENT='{"resource_tag":"", "replica_num":3, "region_split_lines":200000, "namespace":"FENGCHAO"}';
...
CREATE TABLE `Baikaltest`.`student333` (
  ...
  UNIQUE KEY `class2_key` (`class2`),
  KEY `address_key` (`address`)
) ENGINE=Rocksdb DEFAULT CHARSET=gbk AVG_ROW_LENGTH=50 COMMENT='{"resource_tag":"", "replica_num":3, "region_split_lines":2097152, "namespace":"FENGCHAO"}';
