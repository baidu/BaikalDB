...
int check_convert_charset(const std::string& origin_str) {
    ...
    int ret_baikaldb = baikaldb::iconv_convert<pb::GBK, pb::UTF8>(str_gbk_baikaldb, origin_str);
    if (ret_babylon != ret_baikaldb || ret_babylon != 0) {
        return -1;
    }
    if (str_gbk_babylon != str_gbk_baikaldb) {
        return -1;
    }
    ...
    ret_baikaldb = baikaldb::iconv_convert<pb::UTF8, pb::GBK>(str_utf8_baikaldb, str_gbk_baikaldb);
    if (ret_babylon != ret_baikaldb || ret_babylon != 0) {
        return -1;
    }
    if (str_utf8_babylon != str_utf8_baikaldb || str_utf8_babylon != origin_str) {
        return -1;
    }
...
TEST(test_convert_charset_abort, convert_charset) {
    ...
    int ret_baikaldb = baikaldb::iconv_convert<pb::UTF8, pb::GBK>(str_baikaldb, origin_str);
...
TEST(test_convert_charset_ignore, convert_charset) {
    ...
    int ret_baikaldb = baikaldb::iconv_convert<pb::UTF8, pb::GBK, IconvOnError::IGNORE>(str_baikaldb, origin_str);
...
TEST(test_convert_charset_translit, convert_charset) {
    ...
    int ret_baikaldb = baikaldb::iconv_convert<pb::UTF8, pb::GBK, IconvOnError::TRANSLIT>(str_baikaldb, origin_str);
