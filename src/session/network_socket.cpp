...
NetworkSocket::NetworkSocket() {
    ...
    str_node.mutable_derive_node()->set_string_val("28800");
    session_vars["interactive_timeout"] = str_node;
    str_node.mutable_derive_node()->set_string_val("/home/mysql/mysql/share/mysql/english/");
    session_vars["language"] = str_node;
    str_node.mutable_derive_node()->set_string_val("0");
    session_vars["lower_case_table_names"] = str_node;
    str_node.mutable_derive_node()->set_string_val("268435456");
    session_vars["max_allowed_packet"] = str_node;
    str_node.mutable_derive_node()->set_string_val("16384");
    session_vars["net_buffer_length"] = str_node;
    str_node.mutable_derive_node()->set_string_val("60");
    session_vars["net_write_timeout"] = str_node;
    str_node.mutable_derive_node()->set_string_val("335544320");
    session_vars["query_cache_size"] = str_node;
    ...
    str_node.mutable_derive_node()->set_string_val("28800");
    session_vars["wait_timeout"] = str_node;
    str_node.mutable_derive_node()->set_string_val("1");
    session_vars["auto_increment_increment"] = str_node;
