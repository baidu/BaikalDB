...
curl -d '{
    "op_type" : "SetPeer",
    "region_id" : 0,
    "old_peers" : ["127.0.0.1:8110", "127.0.0.1:8110"],
    "new_peers" : ["127.0.0.1:8110", "127.0.0.1:8110", "127.0.0.1:8110"]
}' http://127.0.0.1/MetaService/raft_control
echo -e "\n" 
...
curl -d '{
    "op_type" : "SetPeer",
    "region_id" : 0,
    "old_peers" : ["127.0.0.1", "127.0.0.1:8011"],
    "new_peers" : ["127.0.0.1", "127.0.0.1:8011", "127.0.0.1:8012"]
}' http://127.0.0.1/MetaService/raft_control
echo -e "\n" 
