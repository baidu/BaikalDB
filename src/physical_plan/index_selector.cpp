...
int64_t IndexSelector::index_merge_selector(const std::vector<pb::TupleDescriptor>& tuple_descs,
    ...
    for (auto or_sub_conjunct: or_sub_conjuncts) {
        ...
        index_selector(tuple_descs, scan_node, filter_node, sort_node, join_node,
                       index_has_null, field_range_type, sample_sql); // filter_node's pruned_conjuncts are modified
