...
public:
    ...
    int init(int64_t region_id, bool use_ttl, bool use_normal_ttl, int64_t online_ttl_base_expire_time_us);
    ...
    void update_ttl_info(bool use_ttl, bool use_normal_ttl, int64_t online_ttl_base_expire_time_us) {
        _use_ttl = use_ttl;
